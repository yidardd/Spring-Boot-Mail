...
public class ZipStrUtil extends MainTest {
...
//    }
    ...
    public void test() throws Exception {
        // 字符串超过一定的长度
        String str = " {\"buyer_nick\":\"丶劳资94灬神\",\"payment\":\"2.00\",\"status\":\"TRADE_FINISHED\",\"iid\":576601112865,\"oid\":267762403889391751,\"rater\":\"buyer\",\"tid\":267762403889391751,\"type\":\"guarantee_trade\",\"seller_nick\":\"apis2018\"}";
        System.out.println("\n原始的字符串为------->" + str);
        float len0 = str.length();
        System.out.println("原始的字符串长度为------->" + len0);
        ...
        String ys = compress(str);
        taskRedisTemplate.opsForValue().set("EVALUATION|GOOD_EVALUATION|"+ys,"");

//        String s = taskRedisTemplate.opsForValue().get("EVALUATION:GOOD_EVALUATION:" + ys);
